...
def time_to_decay(
    ...
    """Time after a peak for the signal to decay by `fraction` of its amplitude.

    Shared by the beating (contraction) and calcium-transient analyses.
    ...
    reaches the target level before `end_idx` (e.g. a truncated final
    beat/transient).
    """
